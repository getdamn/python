class katok:
    def __init__(self):
        self.file_input = open("data.txt", 'r', encoding='utf-8')
        self.line = self.file_input.readlines()
    def all_people(self):
        name_dict = {} #결과로 출력할 dict를 초기화 한다.
        for i in range(len(self.line)): #한 줄 씩 받은 리스트가 끝날 때 까지 반복문을 돌린다.
            word = self.line[i].split('"') #XXXX-XX-XX "이름" blabla 이므로 "단위로 쪼갰다.
...
human1.all_people()
print("****************************************************************")
human1.input_most("다솜")
print("****************************************************************")
human2 = katok()
print("****************************************************************")
human2.all_people()
print("****************************************************************")
human2.input_most("안녕하세요")